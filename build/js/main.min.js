...
/* harmony import */ var _modules_modals_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/menu */ "./js/modules/modals/menu.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form */ "./js/modules/form.js");




Object(_modules_modals_menu__WEBPACK_IMPORTED_MODULE_2__["mobileMenu"])();
var userTelInput = document.querySelector('.booking__form-item--tel input');
userTelInput.addEventListener('input', _modules_form__WEBPACK_IMPORTED_MODULE_3__["userTelHandler"]);
var userCheckboxInput = document.querySelector('.booking__checkbox input');
userCheckboxInput.addEventListener('click', _modules_form__WEBPACK_IMPORTED_MODULE_3__["userCheckboxHandler"]); // ---------------------------------
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: userTelHandler, userCheckboxHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "userTelHandler", function() { return userTelHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "userCheckboxHandler", function() { return userCheckboxHandler; });
var telRegexp = /^((8|\+7)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$/;
var userTelInput = document.querySelector('.booking__form-item--tel input');
var userCheckboxInput = document.querySelector('.booking__checkbox input');
var bookingButton = document.getElementById('booking-button');

var userTelHandler = function userTelHandler() {
...
var userCheckboxHandler = function userCheckboxHandler() {
